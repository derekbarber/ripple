...
describe "teacher_availabilities/new" do
  before(:each) do
    assign(:teacher_availability, stub_model(TeacherAvailability,
      :teacher_id => "",
  ...
  it "renders new teacher_availability form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => teacher_availabilities_path, :method => "post" do
