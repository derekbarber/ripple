  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved instrument as @instrument" do
        ...
        post :create, {:instrument => {}}, valid_session
        assigns(:instrument).should be_a_new(Instrument)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested instrument" do
        ...
        put :update, {:id => instrument.to_param, :instrument => {'these' => 'params'}}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the instrument as @instrument" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Instrument.any_instance.stub(:save).and_return(false)
        put :update, {:id => instrument.to_param, :instrument => {}}, valid_session
        assigns(:instrument).should eq(instrument)
      end
